...
#define CALL_ORIG_FUNC(func) Compat30::g_origFuncPtr<&func>

#define HOOK_FUNCTION(module, func, newFunc) \
	Compat30::hookFunction<&func>(#module, #func, &newFunc)
#define HOOK_SHIM_FUNCTION(func, newFunc) \
	Compat30::hookFunction(reinterpret_cast<void*&>(Compat30::g_origFuncPtr<&func>), newFunc, #func)
