...
namespace
{
	...
	void disableDwm8And16BitMitigation()
	{
		...
		Compat30::removeShim(user32, "ChangeDisplaySettingsA");
		Compat30::removeShim(user32, "ChangeDisplaySettingsW");
		Compat30::removeShim(user32, "ChangeDisplaySettingsExA");
		Compat30::removeShim(user32, "ChangeDisplaySettingsExW");
		Compat30::removeShim(user32, "EnumDisplaySettingsA");
		Compat30::removeShim(user32, "EnumDisplaySettingsW");
		Compat30::removeShim(user32, "EnumDisplaySettingsExA");
		Compat30::removeShim(user32, "EnumDisplaySettingsExW");
