...
namespace
{
	...
	CompatPtr<IDirectDrawSurface7> createRenderTarget(CompatRef<IDirectDraw7> dd)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a render target for hooking: " << Compat30::hex(result);
		}
		return renderTarget;
	}
	...
	void hookDirect3dDevice(CompatRef<IDirect3D3> d3d, CompatRef<IDirectDrawSurface4> renderTarget)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a Direct3D device for hooking: " << Compat30::hex(result);
			return;
		}
	...
	void hookDirect3dExecuteBuffer(CompatRef<IDirect3DDevice> dev)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create an execute buffer for hooking: " << Compat30::hex(result);
			return;
		}
	...
	void hookDirect3dLight(CompatRef<IDirect3D3> d3d)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a light for hooking: " << Compat30::hex(result);
			return;
		}
	...
	void hookDirect3dMaterial(CompatRef<IDirect3D3> d3d)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a material for hooking: " << Compat30::hex(result);
			return;
		}
	...
	void hookDirect3dTexture(CompatRef<IDirectDraw> dd)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a texture for hooking: " << Compat30::hex(result);
			return;
		}
	...
	void hookDirect3dVertexBuffer(CompatRef<IDirect3D3> d3d)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a vertex buffer for hooking: " << Compat30::hex(result);
		}
	...
	void hookDirect3dViewport(CompatRef<IDirect3D3> d3d)
	{
		...
		if (FAILED(result))
		{
			Compat30::Log() << "ERROR: Failed to create a Direct3D viewport for hooking: " << Compat30::hex(result);
			return;
		}
