...
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM3_2)
typedef enum _D3D9_UMD_MODE
{
    D3D9_UMD_MODE_NATIVE9 = 0,  // Use PFND3DDDI_OPENADAPTER entrypoint of IHV's UMD
    D3D9_UMD_MODE_SYSTEM9ON12, // Use PFND3D9ON12_OPENADAPTER of OS d3d9on12.dll
    D3D9_UMD_MODE_VENDOR9ON12, // Use PFND3D9ON12_OPENADAPTER of IHV's UMD
} D3D9_UMD_MODE;

typedef _Check_return_ HRESULT (APIENTRY *PFND3D9DDI_QUERYDESIREDMODE)(_In_ PFND3DDDI_ESCAPECB, _In_ D3DKMT_HANDLE, _Out_ D3D9_UMD_MODE*);


#endif // (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM1_3)
...
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_9)
typedef enum _D3DDDI_DLIST_QUERY_RESULT
{
    D3DDDI_DLIST_QUERY_RESULT_NO_DATA = 0,
...
typedef _Check_return_ HRESULT (APIENTRY *PFND3DDDI_QUERYDLISTFORAPPLICATION2)(
        _Out_ D3DDDI_DLIST_QUERY_RESULT*, 
        _Out_ D3DDDI_DLIST_QUERY_DECISION_FACTOR*,
        _In_ HANDLE,
        _In_ PFND3DDDI_ESCAPECB);
#endif

#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM3_2)
typedef enum _D3DDDI_DLIST_MUX_QUERY_RESULT
{
    D3DDDI_DLIST_MUX_QUERY_RESULT_NO_SWITCH_PREFERENCE, // No Data
    D3DDDI_DLIST_MUX_QUERY_RESULT_DISALLOW_SWITCH_PREFERENCE, // Should not trigger a switch 
    D3DDDI_DLIST_MUX_QUERY_RESULT_ALLOW_SWITCH_PREFERENCE, // Can trigger a switch if other conditions are met
    D3DDDI_DLIST_MUX_QUERY_RESULT_DISALLOW_SWITCH_BACKGROUND_BLOCKING_PREFERENCE, // should block switching if running in the background
    D3DDDI_DLIST_MUX_QUERY_RESULT_ALLOW_SWITCH_BACKGROUND_BLOCKING_PREFERENCE
} D3DDDI_DLIST_MUX_QUERY_RESULT;

typedef enum _D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT
{
    D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT_NO_COMPAT_RISK_FOUND = 0,
    D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT_SYSTEM_POWER_LIMIT = 1,
    D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT_CURRENT_APP_INCOMPATIBLE = 2,
    D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT_MIDDLEWARE_TOOL_INCOMPATIBLE = 4
} D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT;

typedef _Check_return_ HRESULT (APIENTRY *PFND3DDDI_QUERYMUXDLISTFORAPPLICATION)(
  _Out_ D3DDDI_DLIST_MUX_QUERY_RESULT *desiredStateForApplication,
  _Out_ D3DDDI_DLIST_QUERY_DECISION_FACTOR *desiredStateForApplicationDecisionFactor,
  _Out_ D3DDDI_DLIST_MUX_QUERY_COMPATIBILITY_RESULT *muxCompatibilityResult,
  _In_  HANDLE hAdapter,
  _In_  PFND3DDDI_ESCAPECB pfnEscapeCB);

#endif // D3D_UMD_INTERFACE_VERSION_WDDM3_2
