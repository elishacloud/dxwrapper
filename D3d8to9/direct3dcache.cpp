...
Direct3DCache::~Direct3DCache()
{
	for (int x = 0; x < SizeOfVector; x++)
	{
		...
		{
			void* MyAddress8 = AddressVector[x].back().Address8;
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pSurface9), SurfaceVector);
	return reinterpret_cast<Direct3DSurface8*>(ret);
}
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pTexture9), TextureVector);
	return reinterpret_cast<Direct3DTexture8*>(ret);
}
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pVolumeTexture9), VolumeTextureVector);
	return reinterpret_cast<Direct3DVolumeTexture8*>(ret);
}
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pCubeTexture9), CubeTextureVector);
	return reinterpret_cast<Direct3DCubeTexture8*>(ret);
}
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pVolume9), VolumeVector);
	return reinterpret_cast<Direct3DVolume8*>(ret);
}
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pVertexBuffer9), VertexBufferVector);
	return reinterpret_cast<Direct3DVertexBuffer8*>(ret);
}
...
{
	void* ret = GetDirect3D(reinterpret_cast<void*>(pIndexBuffer9), IndexBufferVector);
	return reinterpret_cast<Direct3DIndexBuffer8*>(ret);
}
