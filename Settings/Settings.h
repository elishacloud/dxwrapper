...
#define VISIT_CONFIG_SETTINGS(visit) \
	...
	visit(D3d9DisableSwapEffectShim) \
	visit(DisableGameUX) \
...
struct CONFIG
{
	...
	bool D3d9DisableSwapEffectShim = false;		// Disables the call to d3d9.dll 'Direct3D9SetSwapEffectUpgradeShim' to switch present mode
