...
public:
	m_IDirectDrawSurface(IDirectDrawSurface *aOriginal, REFIID riid) : RealInterface(aOriginal)
	{
		ProxyInterface = new m_IDirectDrawSurfaceX((IDirectDrawSurface7*)RealInterface, 1, riid, this);
