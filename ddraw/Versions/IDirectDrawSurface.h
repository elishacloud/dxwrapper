...
class m_IDirectDrawSurface final : public IDirectDrawSurface, public AddressLookupTableDdrawObject
{
private:
	m_IDirectDrawSurfaceX *ProxyInterface;
	const IID WrapperID = IID_IDirectDrawSurface;
...
public:
	...
	IFACEMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE) override;
	IFACEMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT) override;
	IFACEMETHOD(Blt)(THIS_ LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX) override;
	IFACEMETHOD(BltBatch)(THIS_ LPDDBLTBATCH, DWORD, DWORD) override;
	IFACEMETHOD(BltFast)(THIS_ DWORD, DWORD, LPDIRECTDRAWSURFACE, LPRECT, DWORD) override;
	IFACEMETHOD(DeleteAttachedSurface)(THIS_ DWORD, LPDIRECTDRAWSURFACE) override;
	...
	IFACEMETHOD(Flip)(THIS_ LPDIRECTDRAWSURFACE, DWORD) override;
	IFACEMETHOD(GetAttachedSurface)(THIS_ LPDDSCAPS, LPDIRECTDRAWSURFACE FAR *) override;
	...
	IFACEMETHOD(UpdateOverlay)(THIS_ LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDOVERLAYFX) override;
	IFACEMETHOD(UpdateOverlayDisplay)(THIS_ DWORD) override;
	IFACEMETHOD(UpdateOverlayZOrder)(THIS_ DWORD, LPDIRECTDRAWSURFACE) override;
};
