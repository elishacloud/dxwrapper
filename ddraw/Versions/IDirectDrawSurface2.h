...
class m_IDirectDrawSurface2 final : public IDirectDrawSurface2, public AddressLookupTableDdrawObject
{
private:
	m_IDirectDrawSurfaceX *ProxyInterface;
	const IID WrapperID = IID_IDirectDrawSurface2;
...
public:
	...
	IFACEMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE2) override;
	IFACEMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT) override;
	IFACEMETHOD(Blt)(THIS_ LPRECT, LPDIRECTDRAWSURFACE2, LPRECT, DWORD, LPDDBLTFX) override;
	IFACEMETHOD(BltBatch)(THIS_ LPDDBLTBATCH, DWORD, DWORD) override;
	IFACEMETHOD(BltFast)(THIS_ DWORD, DWORD, LPDIRECTDRAWSURFACE2, LPRECT, DWORD) override;
	IFACEMETHOD(DeleteAttachedSurface)(THIS_ DWORD, LPDIRECTDRAWSURFACE2) override;
	...
	IFACEMETHOD(Flip)(THIS_ LPDIRECTDRAWSURFACE2, DWORD) override;
	IFACEMETHOD(GetAttachedSurface)(THIS_ LPDDSCAPS, LPDIRECTDRAWSURFACE2 FAR *) override;
	...
	IFACEMETHOD(UpdateOverlay)(THIS_ LPRECT, LPDIRECTDRAWSURFACE2, LPRECT, DWORD, LPDDOVERLAYFX) override;
	IFACEMETHOD(UpdateOverlayDisplay)(THIS_ DWORD) override;
	IFACEMETHOD(UpdateOverlayZOrder)(THIS_ DWORD, LPDIRECTDRAWSURFACE2) override;
