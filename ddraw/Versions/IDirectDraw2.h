...
class m_IDirectDraw2 final : public IDirectDraw2, public AddressLookupTableDdrawObject
{
private:
...
public:
	m_IDirectDraw2(IDirectDraw2 *, m_IDirectDrawX *Interface) : ProxyInterface(Interface)
	{
