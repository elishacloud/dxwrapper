...
class m_IDirect3DViewport : public IDirect3DViewport, public AddressLookupTableObject
{
private:
	IDirect3DViewport *ProxyInterface;

public:
	m_IDirect3DViewport(IDirect3DViewport *aOriginal, void *) : ProxyInterface(aOriginal)
	{
