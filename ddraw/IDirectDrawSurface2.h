...
public:
	m_IDirectDrawSurface2(IDirectDrawSurface2 *aOriginal, REFIID riid) : RealInterface(aOriginal)
	{
		ProxyInterface = new m_IDirectDrawSurfaceX((IDirectDrawSurface7*)RealInterface, 2, riid, this);
