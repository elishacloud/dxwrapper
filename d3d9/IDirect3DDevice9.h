...
public:
	...
	void SetMultiSampleType(D3DMULTISAMPLE_TYPE MultiSampleType) { DeviceMultiSampleType = MultiSampleType; }
	void SetMultiSampleQuality(DWORD MultiSampleQuality) { DeviceMultiSampleQuality = MultiSampleQuality; }
