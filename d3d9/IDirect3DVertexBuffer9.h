...
class m_IDirect3DVertexBuffer9 final : public IDirect3DVertexBuffer9, public AddressLookupTableD3d9Object
{
private:
...
public:
	...
	IFACEMETHOD(GetDesc)(THIS_ D3DVERTEXBUFFER_DESC *pDesc) override;
